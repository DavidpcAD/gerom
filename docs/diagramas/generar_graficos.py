...
ax.set_title("PN1 · Pareto de productos: las 3 salsas estrella concentran ~81% del ingreso")
...
ax.set_title("PN2 · Ingreso por canal — el Mayoreo aporta ~73% del ingreso")
...
ax.yaxis.set_major_formatter(FuncFormatter(col)); ax.set_ylabel("Ingreso neto")
ax.set_title("PN5 · Concentración de clientes mayoristas (riesgo de dependencia)")
...
ax.set_title("Rotación de inventario: estrella ~0.85 vs baja rotación ~0.25 (sobrestock)")
from matplotlib.patches import Patch

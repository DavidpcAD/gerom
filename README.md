...
cd etl && python3 run_pipeline.py         # genera datos, carga, calidad y ETL
python3 -m streamlit run ../dashboard/app.py  # abre el tablero
```
...
cd etl && python3 generar_fuente_operacional.py && python3 run_pipeline.py
BI_BACKEND=sqlite python3 -m streamlit run ../dashboard/app.py
```
...
## 7. Integrantes
*(Completar con el nombre completo de cada integrante del grupo antes de la entrega.)*
